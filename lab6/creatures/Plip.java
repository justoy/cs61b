...
public class Plip extends Creature {
    ...
    private final double energyStay = 0.2; // energy get after stay
    private final double energyMove = 0.15; // energy lose after move
    private final double energyCapacity=2;
    private final double moveProbability=0.5;

    private void updateG(){
        g=(int)Math.round((255-63)/2.0*(energy-0)+63);
    }
